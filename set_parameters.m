...
par.clusThr = 'n';                   % Determines whether only spikes beyond a certain amplitude are used to cluster, in the batch setting. 
...
par.min_clus = 100;                   % minimum size of a cluster (default 60) 
